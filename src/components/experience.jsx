  ...
  return (
    <section id="experience" className="py-24 px-4 sm:px-8 bg-white dark:bg-slate-900/80 border-t border-slate-200/70 dark:border-slate-800 transition-colors duration-500">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative border-l-2 border-slate-200 dark:border-slate-700 ml-4 sm:ml-8 pl-6 sm:pl-10 space-y-10">
            ...
            >
              ...
              <span
                className={`absolute -left-[31px] sm:-left-[47px] top-6 flex h-4 w-4 items-center justify-center rounded-full ${
                  item.isCurrent
                    ? "bg-sky-500 ring-4 ring-sky-100 dark:ring-sky-950 ring-offset-2 ring-offset-white dark:ring-offset-slate-900"
              ...
              <div className="pro-card p-6 sm:p-8 bg-slate-50/50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 transition-all">
                {/* Header row */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 dark:border-slate-700 pb-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2.5 flex-wrap">
                        ...
                        {item.isCurrent && (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-sky-50 dark:bg-sky-950/60 border border-sky-200 dark:border-sky-800 text-[11px] font-bold text-sky-700 dark:text-sky-300">
                      ...
                      <div className="mt-1 flex items-center gap-2 text-sm">
                        {item.companyUrl ? (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-1 font-semibold text-sky-600 dark:text-sky-400 hover:text-sky-700 transition"
                          >
                  ...
                  <span className="self-start sm:self-center px-3 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-600 dark:text-slate-300">
                    {item.period}
                  </span>
                </div>

                {/* Details list */}
                <ul className="mt-5 space-y-2.5 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {/* Education */}
          <div className="pro-card p-6 sm:p-7 bg-slate-50/50 dark:bg-slate-800/40">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-9 h-9 rounded-xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 flex items-center justify-center text-sky-600 dark:text-sky-400 shadow-2xs">
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white">B.Tech in Artificial Intelligence & Data Science</h3>
              </div>
            </div>
            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mt-2">KGISL Institute of Technology</p>
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-200/80 dark:border-slate-700 text-xs font-medium text-slate-500 dark:text-slate-400">
              <span>Nov 2022 – May 2026</span>
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 font-bold">CGPA: 7.9 / 10</span>
            </div>
          </div>
          ...
          <div className="pro-card p-6 sm:p-7 bg-slate-50/50 dark:bg-slate-800/40">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-9 h-9 rounded-xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-2xs">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white">Key Achievements</h3>
              </div>
            </div>
            <ul className="mt-2 space-y-2 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
